...
| **Plain language** | Humans must understand without decoding jargon or abbreviations ([plain-language.md](../pack-shared/plain-language.md)). Chat replies cut AI tells (`unslop:tells`) |
