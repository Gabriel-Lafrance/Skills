...
Follow `pack-shared/subagents.md`. Rules live in the App UX section of `AGENTS.md` and in `docs/design.md` when that file exists.

**Read first (this turn):**

1. The **Taste** and **Architecture** sections of `AGENTS.md`
2. The App UX section of `AGENTS.md`
...
1. If `docs/design.md` is missing, inventory every app route from code, then write a short Do / Don't list before UI work. Do not overwrite a file that already exists with a blank template.
