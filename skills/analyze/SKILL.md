...
**Read:** [doctrine.md](doctrine.md) · **Ask style:** [../asking.md](../asking.md) · **Taste / structure:** `/taste`, `/architecture` when relevant.

**Subagent model:** omit Task `model`. Wait for Task results — never sleep/poll for subagents.

## Process (outline)

1. Seed workspace under `.agents/temp/analyses/<id>/` (always write)
