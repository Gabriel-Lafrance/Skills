...
description: >-
  ...
  regressions. A+ exam posture without scope drift. Dual skill: agent picks
  standalone vs flow via variants.md. Use for branch review or after validate
  in a goal. User must invoke (not auto).
