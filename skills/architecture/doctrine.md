...
- Numbered explore / implement steps: [`SKILL.md`](SKILL.md)
...
Process (pointers, not a second copy of the bars): Explore → structure card → implement → self-check. Steps live in [SKILL.md](SKILL.md). Bars are the Cite keys above.
