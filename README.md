...
| [`/pr-review`](./skills/pr-review/SKILL.md) | Evaluate a PR: triage actionable priors, rescan; drafts are Blocking or Nit; one publish-as-shown question; post via gh only. |
