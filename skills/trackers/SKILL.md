...
**Hard apply:** [../pack-shared/standards.md](../pack-shared/standards.md) — Read `/taste` and `/architecture` doctrines this turn so ticket AC and constraints are not dropped. Do not skip.
