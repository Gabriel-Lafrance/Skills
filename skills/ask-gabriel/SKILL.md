...
| Last reply sounded generated / unslop that message | `/unslop` |
...
5. Talk in ordinary words ([plain-language.md](../pack-shared/plain-language.md)). Do not use unexplained abbreviations. Skip chatbot closings and puffery; gold-standards loads the unslop doctrine so this reply stays clean.
