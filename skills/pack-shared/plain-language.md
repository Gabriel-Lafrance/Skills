...
8. When the user writes in a language, reply in that language. Product, UI, and locale strings follow the App UX section of `AGENTS.md`: words speakers use for the job, not a word-for-word swap.
