...
| ESLint / Prettier / lint, format, dead code, mutants, quality gates, or install this pack from skills.sh | `/setup-toolkit` (also starts `/design` Initialization if `docs/design.md` is missing) |
