...
description: >-
  ...
  stateless execution context, subagent dispatch, review behavior, and browser
  evidence. Not user-invoked. Other skills link here so shared docs install with
  npx skills (skill folders only).
