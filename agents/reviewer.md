...
2. `code-review/doctrine.md`
3. `pack-shared/review-contract.md`
4. `pack-shared/plain-language.md`
5. The parent Worker Brief (what, injected plan, diff fixed point)
...
- Treat a missing User Rule as permission to skip the Taste and Architecture sections of `AGENTS.md`
