...
description: >-
  ...
  complexity/entropy, never-nest, DRY, throw+try/catch, deep modules. Use
  standalone to audit or apply taste to a lane; parents load it before planning
  or writing code.
...
load flow `/taste` before planning or writing code.
